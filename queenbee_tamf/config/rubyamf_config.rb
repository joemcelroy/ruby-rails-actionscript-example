...
module RubyAMF
  module Configuration
    ...
    ClassMappings.register( 
      :actionscript => 'vyre.timesheets.model.vo.CompanyVO', 
      :ruby => 'Company', 
      :type => 'active_record', 
    ...
    ClassMappings.register( 
      :actionscript => 'vyre.timesheets.model.vo.ProjectVO', 
      :ruby => 'Project', 
      :type => 'active_record', 
    ...
    ClassMappings.register( 
      :actionscript => 'vyre.timesheets.model.vo.UserVO', 
      :ruby => 'User', 
      :type => 'active_record', 
    ...
    ClassMappings.register( 
      :actionscript => 'vyre.timesheets.model.vo.TimesheetVO', 
      :ruby => 'Timesheet', 
      :type => 'active_record', 
      :associations  => ["project"],  
      :attributes => ["id", "description", "day", "hours", "billable_type", "updated_at"]
    )  
